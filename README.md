...
I'm a C++ developer interested in most domains that typically have a need for the language. My background is in science and math, so I'm particularly interested in scientific applications, and complementary topics such as computational geometry. Computational geometry has been on my mind lately both because of ray tracing (3D graphics) and route planning (autonomous vehicles, geographic information systems).
